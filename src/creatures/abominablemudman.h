...
class AbominableMudman : public Creature{
    ...
    public:
        ...
        void attack(Creature& other, int modifier=0) override; // overloaded base function, deals 8 damage and calls dealPercentDmg to determine if extra damage is dealt
